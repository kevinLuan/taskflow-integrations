...
public @interface TaskTimeoutConstraint {
    ...
    class TaskTimeoutValidator implements ConstraintValidator<TaskTimeoutConstraint, TaskDefinition> {
        ...
        @Override
        public boolean isValid(TaskDefinition taskDef, ConstraintValidatorContext context) {
