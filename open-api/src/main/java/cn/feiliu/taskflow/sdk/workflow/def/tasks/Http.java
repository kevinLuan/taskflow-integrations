...
public class Http extends Task<Http> {
    ...
    Http(FlowTask workflowTask) {
        ...
        if (inputRequest != null) {
            this.httpRequest = SerializerFactory.getSerializer().convert(inputRequest, Input.class);
        }
    }
    ...
    public static class Input {
        ...
        @Override
        public int hashCode() {
            return Objects.hash(method, vipAddress, appName, headers, uri, body, accept, contentType,
