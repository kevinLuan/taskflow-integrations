 ...
 */
package cn.feiliu.taskflow.client.util;

public class TestUtil {
    private static int RETRY_ATTEMPT_LIMIT = 4;

    public static void retryMethodCall(VoidRunnableWithException function) throws Exception {
    ...
    public static Object retryMethodCall(RunnableWithException function) throws Exception {
        Exception lastException = null;
        for (int retryCounter = 0; retryCounter < RETRY_ATTEMPT_LIMIT; retryCounter += 1) {
            try {
                return function.run();
